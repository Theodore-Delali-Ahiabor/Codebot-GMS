        ...
        Try
            If btn_new_item_save.Text = "UPDATE" Then
                ...
                If repos = DialogResult.Yes Then
                    sql_ds = New DataSet
                    sql_da = New MySqlDataAdapter("UPDATE inventory SET Category = '" & txt_new_category.Text & "', Part_Name = '" & txt_new_part_name.Text & "', Part_Number = '" & txt_new_part_number.Text & "',
            ...
            ElseIf btn_new_item_save.Text = "SAVE" Then
                Dim repos As DialogResult = MessageBox.Show("You are about to Add a new item to parts, are you sure to continue ?", "Updating User Info", MessageBoxButtons.YesNo, MessageBoxIcon.Information)
                If repos = DialogResult.Yes Then
                    sql_ds = New DataSet
                    sql_da = New MySqlDataAdapter("INSERT INTO inventory(Category,Part_Name,Part_Number,Alternative,Location,Model_Type,Stock,Unit_Cost)
